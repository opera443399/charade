    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exp', models.TextField(max_length=200, null=True, verbose_name='\u89e3\u91ca')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('en', models.CharField(unique=True, max_length=100, verbose_name='en')),
                ('zh', models.CharField(max_length=100, verbose_name='\u4e2d\u6587')),
                ('exp', models.TextField(max_length=200, null=True, verbose_name='\u89e3\u91ca')),
                ('dt', models.DateTimeField(auto_now_add=True, verbose_name='\u6dfb\u52a0\u65f6\u95f4')),
            ],
        ),
    ]
